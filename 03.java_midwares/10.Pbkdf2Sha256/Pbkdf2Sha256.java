...
public class Pbkdf2Sha256 {
    ...
    //private static final Integer DEFAULT_ITERATIONS = 180000;
    private static final Integer DEFAULT_ITERATIONS = 320000;
    /**
     * 算法名称
     */
    ...
    public static String getEncodedHash(String password, String salt, int iterations) {
        ...
        try {
        	...
        	System.out.println("Could NOT retrieve PBKDF2WithHmacSHA256 algorithm" + e);
        }
        salt = "2m0dhbDZQ4vIbwujHL8ygc";
        ...
        try {
        	...
        	System.out.println("Could NOT generate secret key" + e);
        }
    ...
    public static String encode(String password, String salt) {
    	System.out.println("in encode(), password:" + password + ", salt:"+ salt + ", iterations:" + DEFAULT_ITERATIONS);
    ...
    public static String encode(String password, String salt, int iterations) {
        ...
        System.out.println("in encode: hash:" + hash);
